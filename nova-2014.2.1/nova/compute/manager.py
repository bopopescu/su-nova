...
class ComputeManager(manager.Manager):
    ...
    def _validate_instance_relative_group_policy(self, context, instance,
            filter_properties):
        ...
        group_hint = scheduler_hints.get('relativeDispersionGroup')
        if not group_hint:
            return
        ...
        def _do_validation(context, instance, group_hint):
            ...
            if self.host in group_hosts:
                msg = "Anti-affinity instance group policy was violated."
        ...
        try:
            ...
            with rt.instance_claim(context, instance, limits) as inst_claim:
                ...
                self._validate_instance_group_policy(context, instance,
                        filter_properties)
                self._validate_instance_relative_group_policy(context, instance,
                        filter_properties)
    ...
    def _rebuild_default_impl(self, context, instance, image_meta,
        ...
        #ADD by zhjh evacuate instance with migrating port binding. 2015-02-13
        if recreate:
    ...
    @periodic_task.periodic_task(spacing=CONF.report_interval)
