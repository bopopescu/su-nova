...
class LibvirtDriver(driver.ComputeDriver):
    ...
    #ADD by zhjh 2015-02-28 migrate host vgs metadata from icehouse.
    @staticmethod
    def get_cinder_vgs_info():
        """Get cinder manage lvm storage info of the compute node in GB.

        :returns: A dict containing:
             :total: How big the overall usable  is (in gigabytes)
             :free: How much space is free (in gigabytes)
             :used: How much space is used (in gigabytes)
        """

        info = lvm.get_volume_openstack_group_info(CONF.libvirt.cinder_volume_group)
...
class HostState(object):
    ...
    def update_status(self):
        ...
        cinder_vg_info_dict = {}
        try:
            cinder_vg_info_dict = self.driver.get_cinder_vgs_info()
        except Exception as e:
            LOG.error("This is no cinder_volume_group vg")
            cinder_vg_info_dict['total'] = 0
            cinder_vg_info_dict['used'] = 0
            cinder_vg_info_dict['free'] = 0
        ...
        #ADD by zhjh 2015-02-28 migrate host vgs metadata from icehouse.
        cinder_stats = {}
        cinder_stats['cinder_vgs_total'] = cinder_vg_info_dict['total']
        cinder_stats['cinder_vgs_used'] = cinder_vg_info_dict['used']
        cinder_stats['cinder_vgs_free'] = cinder_vg_info_dict['free']
        data['stats'] = cinder_stats
