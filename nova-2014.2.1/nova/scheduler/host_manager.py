...
class HostState(object):
    ...
    def __init__(self, host, node, compute=None):
        ...
        #cinder manager vgs storage
        self.cinder_vgs_total = 0
        self.cinder_vgs_used = 0
        self.cinder_vgs_free = 0
    ...
    def update_from_compute_node(self, compute):
        ...
        # Track cinder manager vgs total, used,free storage GB
        self.cinder_vgs_total = int(self.stats.get('cinder_vgs_total', 0))
        self.cinder_vgs_used = int(self.stats.get('cinder_vgs_used', 0))
        self.cinder_vgs_free = int(self.stats.get('cinder_vgs_free', 0))
