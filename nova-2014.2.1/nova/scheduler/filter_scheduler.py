...
class FilterScheduler(driver.Scheduler):
    ...
    def select_destinations(self, context, request_spec, filter_properties):
        ...
        if not selected_hosts:
            ...
            if group_uuid:
                scheduler_hints.pop('relativeDispersionGroup')
                filter_properties.pop('relative_group_hosts')
                selected_hosts = self._schedule(context, request_spec, filter_properties)
    ...
    #ADD by zhjh 2015-02-27 migrate relative group scheduler hints from icehouse.
    def _setup_instance_relative_group(self, context, filter_properties):
        update_group_hosts = False
        scheduler_hints = filter_properties.get('scheduler_hints') or {}
